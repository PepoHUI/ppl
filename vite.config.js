  ...
  build: {
    rollupOptions: {
      input: {
        ...
        background: resolve(__dirname, "tools/background/index.html"),
        ytDlp: resolve(__dirname, "tools/yt-dlp/index.html"),
        respackopts: resolve(__dirname, "tools/respackopts/index.html"),
